...
class _FieldVisitorDashboardState extends State<FieldVisitorDashboard> {
  ...
  Future<void> _loadMembers() async {
    if (AppSession.fieldVisitorId == null) {
      debugPrint('Cannot load members: fieldVisitorId is null');
      return;
    }
    ...
    try {
      ...
      debugPrint('Received ${members.length} members from API');
    ...
    return all
        .where(
          (m) =>
              ...
              (m['mobile'] as String).toLowerCase().contains(q) ||
              (m['billNumber'] as String).toLowerCase().contains(q),
        )
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Dynamic counts: use API stats if available, else fallback to store
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () => Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) =>
                                      const FieldVisitorMyProfileScreen(),
                                ),
                              ),
                              child: Row(
                                children: [
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration(
                                    ...
                                    hintText:
                                        "Search by name, mobile or Bill number...",
                                    hintStyle: TextStyle(
                                      fontSize: 13,
                                      color: Colors.grey,
                                    ),
